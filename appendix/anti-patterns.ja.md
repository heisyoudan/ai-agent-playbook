...
**日本語** · [English](anti-patterns.md) · [简体中文](anti-patterns.zh-CN.md)

> **翻訳の状態：** 簡体字中国語版が canonical である。中国語版の方法論はこのページが書かれた後に更新されているため、本訳は遅れている可能性がある。
...
[付録B → AI 出力の検収戦略](verification-strategies.ja.md) · [付録C → 早見表](cheatsheet.ja.md) · [← README に戻る](../README.md)
